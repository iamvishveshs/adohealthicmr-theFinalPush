...
// Validate and configure Cloudinary at module load
 ...
 * 
 * Response:
 * - Success (200): JSON with Cloudinary upload result
 * - Error (4xx/5xx): JSON with error message and details
 */
export async function POST(request) {
  ...
  try {
    ...
    // Step 5: Return the uploaded Cloudinary result in JSON response
    return NextResponse.json({
      success: true,
